    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid grid-cols-2 gap-4">
        ...
        <Field
          ...
          viewHref={fields.species && speciesIdByName[fields.species] ? `/play/species/${speciesIdByName[fields.species]}` : undefined}
        >
        ...
        <Field
          label="Culture"
          viewHref={fields.culture && cultureIdByName[fields.culture] ? `/play/cultures/${cultureIdByName[fields.culture]}` : undefined}
        >
