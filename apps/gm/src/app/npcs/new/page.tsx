...
export default function NewNpcPage() {
  return (
    <div className="p-8 max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-zinc-900 mb-6">New NPC</h1>
      ...
      <form action={createNpc} className="space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/npcs" className="rounded-md border border-zinc-300 bg-white px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50">
            Cancel
          </Link>
        </div>
      </form>
