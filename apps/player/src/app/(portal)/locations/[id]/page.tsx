  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="flex items-center gap-2 mb-6 text-sm">
        <Link href="/locations" className="text-slate-500 hover:text-slate-300">Locations</Link>
        {parent && (
          <>
            <span className="text-slate-600">/</span>
            <Link href={`/locations/${parent.id}`} className="text-slate-500 hover:text-slate-300">{parent.name}</Link>
          </>
        )}
        <span className="text-slate-600">/</span>
